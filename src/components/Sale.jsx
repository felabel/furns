    ...
    return (
        <div className='my-20'>
            <div className ='wrapper w-full h-auto my-10'>
                <div className="grid lg:grid-cols-2 w-full h-66 md:h-auto gap-4  px-4">
                    {/* first div */}
                <div className="left bg-[url('/images/slideone.jpg')] bg-gray-400 bg-no-repeat bg-cover p-4  md:p-14 relative h-44 md:h-80">
                ...
                <div className="right bg-[url('/images/slider2.jpg')] bg-no-repeat bg-cover relative p-4 md:p-14 h-44 md:h-80">
